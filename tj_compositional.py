...
# methods = ['baseline_mac_easy_mha_compositional_100_0.01loss_cts_2_min']
...
methods = ['baseline_mac_easy_mha_compositional_100_0loss_qual',
            'baseline_mac_easy_mha_compositional_100_0.001loss_qual',
            'baseline_mac_easy_mha_compositional_100_0.01loss_qual',
            'baseline_mac_easy_mha_compositional_100_0.1loss_qual']
# methods = [
...
# methods = ['baseline_mac_medium_mha_compositional_tokenfix_100_0.01loss_good']
...
comp_beta = 0.01
for method, comp_beta in zip(methods, [0.0,0.001,0.01,0.1]):
# for method in methods:
    ...
    if "easy" in method:
        ...
        protos_list = [1120] # use 1 layer of redundancy
        comms_list = [64]
        num_epochs = 2500
    elif 'hard' in method:
    ...
    for num_proto in protos_list:
        exp_name = "tj_" + method + str(num_proto)
        vision = 0
        soft_budget = 0.7
